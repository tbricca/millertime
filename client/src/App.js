          ...
          <div id="header" className="navbar navbar-default navbar-fixed-top">
            ...
            <nav className="collapse navbar-collapse">
              ...
              <ul className="nav navbar-nav pull-right">
                <li className="dropdown">
                  <a href="#" id="nbAcctDD" className="dropdown-toggle" data-toggle="dropdown"><i className="icon-user"></i> < Headline /> The Magnicent<i className="icon-sort-down"></i></a>
            ...
            <div id="sidebar-wrapper" className="col-md-2">
              ...
              <div id="main-wrapper" className="col-md-10 pull-right">
                ...
                <div className="col-md-12 footer">
                  <ul className="nav navbar-nav">A Project Inspired by Beth Miller, Cooked Up By: Chad Coker, Brian Conner, Reggie Baker and Tony Bricca</ul>
                </div>
              </div>
          </div>
        </div>
